!(function (e, t) {
                        ...
                        for (t in e)
                            (n = s[t]),
                                s !== (r = e[t]) &&
                                    (l &&
                                    r &&
                                    (E.isPlainObject(r) || (i = E.isArray(r)))
                                        ? ((o = i
                                              ? ((i = !1),
                                                n && E.isArray(n) ? n : [])
                                              : n && E.isPlainObject(n)
                    ...
                    if (((n = n || []), 1 === c.length)) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                (r = u(
                                    s.matches[0].replace(ne, f),
                                    (ee.test(o[0].type) && pe(t.parentNode)) ||
                                        t
                                ))
                            ) {
    ...
    (E.filter = function (e, t, n) {
        ...
        E.fn.extend({
            find: function (e) {
                ...
                return (
                    ((r = this.pushStack(1 < n ? E.unique(r) : r)).selector =
            ...
            is: function (e) {
                return !!T(
                    this,
                    "string" == typeof e && x.test(e) ? E(e) : e || [],
                    !1
                ).length;
            },
        });
            ...
            function (r, i) {
                E.fn[r] = function (e, t) {
                    ...
                    return (
                        ...
                        1 < this.length &&
                            (D[r] || E.uniqueSort(n), j.test(r) && n.reverse()),
                        this.pushStack(n)
                    );
                };
            }
        ...
        E.extend({
            ...
            ready: function (e) {
                (!0 === e ? --E.readyWait : E.isReady) ||
                    ...
                    (q.resolveWith(k, [E]),
                    E.fn.triggerHandler &&
                        (E(k).triggerHandler("ready"), E(k).off("ready")));
            },
        }),
                ...
                if (
                    ...
                    for (t = s.length; t--; )
                        s[t] &&
                            ...
                            ((n = E.camelCase(n.slice(5))), $(o, n, i[n]));
    ...
    function ye(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            M.hasData(e) &&
                ((a = M.access(e)), (u = E.extend({}, a)), M.set(t, u));
        }
    }
    function xe(n, r, i, o) {
        r = g.apply([], r);
        ...
        if (
            ...
            if (a)
                for (
                    l = s[s.length - 1].ownerDocument, E.map(s, me), c = 0;
                    c < a;
                    c++
                )
                    (u = s[c]),
    ...
    function be(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || E.cleanData(J(r)),
                r.parentNode &&
                    (n && E.contains(r.ownerDocument, r) && K(J(r, "script")),
    ...
    E.extend({
        ...
        clone: function (e, t, n) {
            ...
            return (
                0 < (s = J(c, "script")).length && K(s, !f && J(e, "script")), c
            );
        },
        ...
        return (
            n ||
                (("none" !== (n = Ce(e, t)) && n) ||
                    ((t = (we = (
                        we ||
                        E("<iframe frameborder='0' width='0' height='0'/>")
                ...
                E.extend(v, {
                    ...
                    reliableMarginRight: function () {
                        ...
                        return (
                            ...
                            De.appendChild(o),
                            (e = !parseFloat(
                                C.getComputedStyle(t).marginRight
                            )),
                            De.removeChild(o),
                            s.removeChild(t),
                            e
    ...
    function Ie(e, t, n, r, i) {
        for (
            ...
            "margin" === n && (s += E.css(e, n + z[o], !0, i)),
                r
                    ? ("content" === n &&
                          (s -= E.css(e, "padding" + z[o], !0, i)),
                      "margin" !== n &&
                          (s -= E.css(e, "border" + z[o] + "Width", !0, i)))
                    : ((s += E.css(e, "padding" + z[o], !0, i)),
                      "padding" !== n &&
                          (s += E.css(e, "border" + z[o] + "Width", !0, i)));
        return s;
        ...
        for (var n, r, i, o = [], s = 0, a = e.length; s < a; s++)
            (r = e[s]).style &&
                ...
                t
                    ...
                    : ((i = B(r)),
                      ("none" === n && i) ||
                          R.set(r, "olddisplay", i ? n : E.css(r, "display"))));
        for (s = 0; s < a; s++)
            (r = e[s]).style &&
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    u = e.style;
                return (
                    (t = E.cssProps[a] || (E.cssProps[a] = Re(a) || a)),
    ...
    (E.Animation = E.extend(Ze, {
        ...
        tweener: function (e, t) {
            for (
                var n,
                    r = 0,
                    i = (e = E.isFunction(e) ? ((t = e), ["*"]) : e.match(L))
                        .length;
                r < i;
                r++
            )
