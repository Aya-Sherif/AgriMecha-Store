            ...
            focus: function (t) {
                ...
                o.instance.current &&
                    ...
                    (i.top < 0 || i.top > s.height() - e.outerHeight())
                        ? s
                              .stop()
                              .animate({ scrollTop: s.scrollTop() + i.top }, t)
                        : "x" === o.opts.axis &&
                          (i.left < n.scrollLeft() ||
                              i.left >
                                  n.scrollLeft() +
                        ...
                        $.ajax({
                            ...
                            error: function (error) {
                                var errorMessage =
                                    ...
                                    '"</span>';
                                note.html(errorMessage);
                            },
                            complete: function () {
                                // Any additional actions to perform after AJAX request completes
                            },
                        });
