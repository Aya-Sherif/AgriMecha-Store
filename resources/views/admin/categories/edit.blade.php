            ...
            <div class="col-md-6 col-sm-6 mx-auto">
                <div class="x_panel">
                    ...
                    <div class="x_content ">
                        ...
                        <form id="demo-form2" method="post" action="{{route('admin.categories.update',$category->id)}}" data-parsley-validate="" class="form-horizontal form-label-left " novalidate="">
                            @csrf
                            @method('PUT')
