	...
	<body>
		<div id="app">
			...
			<header id="top-bar" class="top-bar top-bar--style-1">
				<div class="top-bar__bg" style="background-color: #24292c;background-image: url({{asset("front")}}/img/top_bar_bg-1.jpg);background-repeat: no-repeat;background-position: left bottom;"></div>

				<div class="container-fluid">
					<div class="row align-items-center justify-content-between no-gutters">

						<a class="top-bar__logo site-logo" href="index.html">
							<img class="img-fluid" src="{{asset("front")}}/img/site_logo.png" alt="demo" />
						</a>
									...
									jQuery(document).ready(function($){
										...
										var slider = $('#vegas-slider'),
											slides = [
												{
													name: "img 1",
													src: '{{asset("front")}}/img/home_img/img_1.jpg'
												},
												{
													name: "img 2",
													src: '{{asset("front")}}/img/home_img/img_2.jpg'
												},
												{
													name: "img 3",
													src: '{{asset("front")}}/img/home_img/img_3.jpg'
												}
											],
										...
										slider.vegas({
											...
											delay: 5000,
											slides: slides,
											overlay: '{{asset("front")}}/img/home_img/overlays/05.png',
			...
			<main role="main">
								...
								<div class="row">
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="100" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/1.png" alt="demo" />
											</i>
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/2.png" alt="demo" />
											</i>
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="300" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/3.png" alt="demo" />
											</i>
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="400" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/4.png" alt="demo" />
											</i>
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="500" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/5.png" alt="demo" />
											</i>
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="600" data-aos-offset="100">
											<i class="__ico">
												<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/feature_img/6.png" alt="demo" />
											</i>
				...
				<section class="section section--no-pt section--no-pb">
					<div class="container">
						<div class="special-offer special-offer--style-1" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="70">
							<h2 class="text text-center lazy"  data-src="{{asset("front")}}/img/special_offer_text_bg.jpg">Special products for most people</h2>
						</div>
					</div>
				</section>
				<!-- end section -->
				...
				<section class="section">
					<div class="d-none d-lg-block">
						<img id="bg-img-1" class="img-fluid lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/agro.png" alt="demo" />
						<style type="text/css">
							#bg-img-1
							{
								position: absolute;
						...
						<div class="row align-items-center">
							...
							<div class="col-12 col-lg-4  text-center">
								<div data-aos="fade-up" ddata-aos-duration="600" data-aos-offset="100">
									<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/img_1.png" alt="demo" />
								</div>
							</div>
										...
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="150">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/ico/ico_count_1.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="300">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/ico/ico_count_2.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="450">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/ico/ico_count_3.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="600">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/ico/ico_count_4.png" alt="demo" />
													</i>
												</div>
				...
				<section class="section">
					<div class="container">
						...
						<div data-aos="slide-up" data-aos-duration="800" data-aos-offset="50">
							<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/img_world_map.png" alt="demo" />
						</div>
					</div>
				</section>
				<!-- end section -->
							...
							<div class="__inner">
								<div class="row">
									...
									<div class="col-12 col-md-5 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/1.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/2.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/3.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/4.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-md-7 col-xl-6 offset-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/5.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-md-5 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/product-preview_img/6.jpg"  alt="demo" />
											</figure>
					...
					<div class="simple-banner simple-banner--style-1" data-aos="fade" data-aos-offset="50">
						...
						<div class="container">
							<div class="row">
								<div class="col-12">
									<div class="__inner">
										<img class="img-fluid  lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/site_logo.png" alt="demo" />
								...
								<div class="row">
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="100" data-aos-offset="0">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/posts_img/1.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="200" data-aos-offset="0">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/posts_img/2.jpg" alt="demo" />
											</figure>
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="300" data-aos-offset="0">
											<figure class="__image">
												<img class="lazy" src="{{asset("front")}}/img/blank.gif" data-src="{{asset("front")}}/img/posts_img/3.jpg" alt="demo" />
											</figure>
					...
					<div class="container">
						<div class="partners-list">
							<div class="js-slick"
								...
								<div class="__item">
									<img class="img-fluid m-auto" src="{{asset("front")}}/img/partners_img/1.jpg" alt="demo" />
								</div>

								<div class="__item">
									<img class="img-fluid m-auto" src="{{asset("front")}}/img/partners_img/2.jpg" alt="demo" />
								</div>

								<div class="__item">
									<img class="img-fluid m-auto" src="{{asset("front")}}/img/partners_img/3.jpg" alt="demo" />
								</div>

								<div class="__item">
									<img class="img-fluid m-auto" src="{{asset("front")}}/img/partners_img/4.jpg" alt="demo" />
								</div>

								<div class="__item">
									<img class="img-fluid m-auto" src="{{asset("front")}}/img/partners_img/5.jpg" alt="demo" />
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section section--no-pt section--no-pb">
					...
					<div class="g_map" data-api-key="AIzaSyBXQROV5YMCERGIIuwxrmaZbBl_Wm4Dy5U" data-longitude="44.958309" data-latitude="34.109925" data-marker="{{asset("front")}}/img/marker.png" style="min-height: 255px"></div>
				</section>
				<!-- end section -->
			</main>
			<!-- end main -->
		...
		<script>window.jQuery || document.write('<script src="{{asset("front")}}/js/jquery-2.2.4.min.js"><\/script>')</script>
